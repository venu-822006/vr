  ...
  try {
    ...
    if (pCheck.rowCount === 0) {
      ...
      const seeds = [
        ...
        { name:'Lady\'s finger',te:'బెండకాయ',emoji:'🥒',cat:'Daily Veg',unit:'kg',price:45,w:30,bulk:true,img:'/images/okra_1783693590479.png' },
        { name:'Beans',te:'బీన్స్',emoji:'🫛',cat:'Daily Veg',unit:'kg',price:80,w:65,bulk:true,img:'/images/green_beans_1783693716685.png' },
        ...
        { name:'Drum stick',te:'ములక్కాడ',emoji:'🥢',cat:'Daily Veg',unit:'bunch',price:25,w:null,bulk:false,img:'/images/drumstick_1783693728016.png' },
